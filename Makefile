...
github-release:
	...
	docker run -e GITHUB_TOKEN=$(GITHUB_TOKEN) --rm  -v $(PWD):/workdir -w /workdir cbroglie/goreleaser-cgo:1.12.12-musl apt-get install -y gcc-aarch64-linux-gnu && goreleaser --rm-dist
